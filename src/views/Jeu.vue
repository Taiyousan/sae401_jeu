...
<template>
    <div class="app">
        <h1>PLATEAU J1</h1>
        <p class="indication">Cette partie est générée aléatoirement. Les plateaux sont différents à chaque refresh, mais on peut en sauvegarder la configuration avec le bouton en bas, qui génère un .json. On peut réutiliser ce .json pour générer le même plateau plus tard.</p>
        <div class="plateau">
